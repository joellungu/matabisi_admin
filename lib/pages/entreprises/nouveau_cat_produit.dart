...
class NouveauCatProduit extends StatefulWidget {
  const NouveauCatProduit({super.key});

  @override
  State<NouveauCatProduit> createState() => _EntrepriseFormPageState();
}

class _EntrepriseFormPageState extends State<NouveauCatProduit> {
